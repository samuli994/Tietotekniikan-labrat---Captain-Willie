...
public class FirstPersonController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Set volume to the player set level
    ...
    private void Update()
    {
        ...
        if (isWalking && isGrounded && !walkingAudio.isPlaying) {
            walkingAudio.Play();
        }
        if (!isWalking && isGrounded && walkingAudio.isPlaying) {
            walkingAudio.Stop();
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.walkingAudio = (AudioSource)EditorGUILayout.ObjectField(new GUIContent("Walking Audio", "Player walking sound."), fpc.walkingAudio, typeof(AudioSource), true);
